...
export default function ModalWindow() {
    ...
    return (
        <div>
        <button type="button" class="btn btn-outline-primary" onClick={handleShow}> <img src="https://pic.onlinewebfonts.com/svg/img_360305.png" alt="" width="40" height="40"></img> </button>
